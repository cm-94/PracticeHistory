...
import com.example.btchat.fragments.ExampleFragment;
import com.example.btchat.fragments.FragmentAdapter;
import com.example.btchat.fragments.IFragmentListener;
import com.example.btchat.service.BTCTemplateService;
import com.example.btchat.utils.AppSettings;
import com.example.btchat.utils.Constants;
import com.example.btchat.utils.Logs;
import com.example.btchat.utils.RecycleUtils;
            ...
            switch(msg.what) {
                ...
                case Constants.MESSAGE_READ_CHAT_DATA:
                    if(msg.obj != null) {
                        ...
                        frg.showMessage((String)msg.obj); // => Fragment에서 받은 메시지 출력!!
                    }
                    break;
