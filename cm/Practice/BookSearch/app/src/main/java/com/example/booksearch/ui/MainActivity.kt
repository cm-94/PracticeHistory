    ...
    private fun requestBook(query: String, start: Int, display: Int){
        ...
        RetrofitUtils.getBookService().searchBookItem(query, start, display).enqueue(object :
            ...
            override fun onResponse(
                ...
                Log.d("Receive_data","response.body: ${response.body()?.string()}")
...
//                var book = gson.fromJson(jsonReader,BookData::class)

                var bookData : BookItem = gson.fromJson(jsonReader,BookData::class.java)
